...
static void add_header(mapping **hashmap, char *name_space, char *header, int name_space_only);
...
static struct option longopts[] = {
    ...
    {"namespace_only", no_argument, NULL, 'y'},
...
static void parse_args(mapping **entries, char **av, int ac) {
    ...
    for (; *av; av++) {
        ...
        add_header(entries, cli_args.name_space, *av, name_space_only);
    }
}
